 ...
 * using the {@link ServiceLoader} mechanism. A resolver approach is used, as opposed to directly looking
 * up {@link TracerObserver} implementations, as the initialisation of some observers may be more
 * complex.
 */
